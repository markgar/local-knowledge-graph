...
> **Historical specification, archived 2026-09-20.** This preserves the original
> implementation ledger, experiment sequence, and unmet acceptance gates.
> Old commands and stage prerequisites below describe history, not supported
> product workflows. Use the current [`SPEC.md`](../../SPEC.md) and
> [`README.md`](../../README.md). Reproduction instructions and measured results
> remain in [`QASPER`](../qasper/README.md), [`QASPER results`](../qasper/RESULTS.md),
> [`agent evaluation`](../agent/README.md), and
...
be added to [`benchmarks/qasper/RESULTS.md`](../qasper/RESULTS.md)
